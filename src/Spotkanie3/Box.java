...
public class Box {
    ...
    public static void main(String[] args) {
        Box box;
        System.out.println("Wywolywanie BOX ze wspólżędnymi: (25,25) i (50,50)");
        box = new Box(25,25,50,50);
        box.printBox();
        System.out.println();
        System.out.println("Wywolywanie BOX z punktami: (10,10) i (20,20)");
        box = new Box(new Point(10,10), new Point(20,20));
        box.printBox();
        System.out.println();
        System.out.println("Wywolywanie BOX z punktem: (10,10) o szyrokośći 50 i wysokość 50");
